  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
            ...
            <div className="group relative">
              ...
              <div className="relative bg-black/10 backdrop-blur-2xl rounded-4xl shadow-2xl border border-white/10 overflow-hidden hover:shadow-[0_40px_80px_rgba(0,0,0,0.25)] transition-all duration-1000">
                <div className="bg-gradient-to-r from-violet-500 via-purple-600 to-fuchsia-700 px-10 py-12 relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www3.org/2000/svg"%3E%3Cg fill="%23ffffff" fill-opacity="0.1"%3E%3Cpath d="M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z"/%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>
      ...
      <style jsx>{`
        ...
        .animate-blob-slower {
          animation: blob-slower 12s infinite;
        }
        .rounded-4xl {
          border-radius: 2rem;
        }
